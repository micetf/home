...
function Navbar({ pageTitle = "Accueil" }) {
    ...
    const handleContact = () => {
        window.location.href = `mailto:webmaster@micetf.fr?subject=Au sujet de ${document.location.pathname}`;
    };
            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        {/* Boutons d'action - Ordre optimisé pour SEO/UX */}
                        <div className="flex space-x-2">
                            {/* 1. Outils (prioritaire pour la recherche) */}
                            <a
                ...
                {isMenuOpen && (
                    <div className="md:hidden py-4 px-2 bg-gray-800 mt-2 rounded-lg shadow-xl transition-all duration-300">
                        <div className="space-y-4">
                            ...
                            <a
                                href="https://micetf.fr/index/"
                                className="flex items-center gap-2 py-3 px-4 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20"
